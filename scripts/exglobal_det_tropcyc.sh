#!/bin/bash
export PS4=' + exglobal_det_tropcyc.sh line $LINENO: '
...
#      cp -r ${STORMroot}/plot/${tc_name}/images/* ${COMOUTroot}/plots/.
      cp ${STORMroot}/plot/${tc_name}/images/ABSAMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_global.gif ${COMOUTroot}/plots/evs.hurricane_global_det.abswind_err.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
      cp ${STORMroot}/plot/${tc_name}/images/AMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_global.gif ${COMOUTroot}/plots/evs.hurricane_global_det.wind_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png 
      cp ${STORMroot}/plot/${tc_name}/images/ABSTK_ERR_fhrmean_${tc_name}_global.gif ${COMOUTroot}/plots/evs.hurricane_global_det.abstk_err.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
      cp ${STORMroot}/plot/${tc_name}/images/ALTK_ERR_fhrmean_${tc_name}_global.gif ${COMOUTroot}/plots/evs.hurricane_global_det.altk_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
      cp ${STORMroot}/plot/${tc_name}/images/CRTK_ERR_fhrmean_${tc_name}_global.gif ${COMOUTroot}/plots/evs.hurricane_global_det.crtk_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
    fi   
  fi
fi
...
#      cp -r ${metTCcomout}/plot/${tc_name}/images/* ${COMOUTbas}/plots/.
      cp -r ${metTCcomout}/plot/${tc_name}/images/ABSAMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_global.gif ${COMOUTbas}/plots/evs.hurricane_global_det.abswind_err.${stormBasin}.${stormYear}.season.png
      cp -r ${metTCcomout}/plot/${tc_name}/images/AMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_global.gif ${COMOUTbas}/plots/evs.hurricane_global_det.wind_bias.${stormBasin}.${stormYear}.season.png
      cp -r ${metTCcomout}/plot/${tc_name}/images/ABSTK_ERR_fhrmean_${tc_name}_global.gif ${COMOUTbas}/plots/evs.hurricane_global_det.abstk_err.${stormBasin}.${stormYear}.season.png
      cp -r ${metTCcomout}/plot/${tc_name}/images/ALTK_ERR_fhrmean_${tc_name}_global.gif ${COMOUTbas}/plots/evs.hurricane_global_det.altk_bias.${stormBasin}.${stormYear}.season.png
      cp -r ${metTCcomout}/plot/${tc_name}/images/CRTK_ERR_fhrmean_${tc_name}_global.gif ${COMOUTbas}/plots/evs.hurricane_global_det.crtk_bias.${stormBasin}.${stormYear}.season.png
    fi   
  fi
fi
###### bas do loop end ######

#!/bin/bash
export PS4=' + exregional_tropcyc.sh line $LINENO: '

#----For regional models, there will be 5-days verifications. 
export Model_Plot="GFS,HWRF,HMON,CTCX"
...
#---get the model forecast tracks "AVNO/HWRF/HMON/CTCX" from archive file "tracks.atcfunix.${YY22}"
...
#--- run for TC_pairs
cp ${PARMtc_verify}/TCPairs_template.conf .
...
#--- run for TC_stat 
cd $STORMdata
cp ${PARMtc_verify}/TCStat_template.conf .
...
python ${USHtc_verify}/plot_tropcyc_lead_average.py
...
#      cp -r ${STORMroot}/plot/${tc_name}/images/* ${COMOUTroot}/plots/.
      cp ${STORMroot}/plot/${tc_name}/images/ABSAMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_regional.gif ${COMOUTroot}/plots/evs.hurricane_regional.abswind_err.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
      cp ${STORMroot}/plot/${tc_name}/images/AMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_regional.gif ${COMOUTroot}/plots/evs.hurricane_regional.wind_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png 
      cp ${STORMroot}/plot/${tc_name}/images/ABSTK_ERR_fhrmean_${tc_name}_regional.gif ${COMOUTroot}/plots/evs.hurricane_regional.abstk_err.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
      cp ${STORMroot}/plot/${tc_name}/images/ALTK_ERR_fhrmean_${tc_name}_regional.gif ${COMOUTroot}/plots/evs.hurricane_regional.altk_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
      cp ${STORMroot}/plot/${tc_name}/images/CRTK_ERR_fhrmean_${tc_name}_regional.gif ${COMOUTroot}/plots/evs.hurricane_regional.crtk_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
    fi   
  fi
fi
...
cp ${PARMtc_verify}/TCStat_template_basin.conf .
...
#      cp -r ${metTCcomout}/plot/${tc_name}/images/* ${COMOUTbas}/plots/.
      cp -r ${metTCcomout}/plot/${tc_name}/images/ABSAMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_regional.gif ${COMOUTbas}/plots/evs.hurricane_regional.abswind_err.${stormBasin}.${stormYear}.season.png
      cp -r ${metTCcomout}/plot/${tc_name}/images/AMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_regional.gif ${COMOUTbas}/plots/evs.hurricane_regional.wind_bias.${stormBasin}.${stormYear}.season.png
      cp -r ${metTCcomout}/plot/${tc_name}/images/ABSTK_ERR_fhrmean_${tc_name}_regional.gif ${COMOUTbas}/plots/evs.hurricane_regional.abstk_err.${stormBasin}.${stormYear}.season.png
      cp -r ${metTCcomout}/plot/${tc_name}/images/ALTK_ERR_fhrmean_${tc_name}_regional.gif ${COMOUTbas}/plots/evs.hurricane_regional.altk_bias.${stormBasin}.${stormYear}.season.png
      cp -r ${metTCcomout}/plot/${tc_name}/images/CRTK_ERR_fhrmean_${tc_name}_regional.gif ${COMOUTbas}/plots/evs.hurricane_regional.crtk_bias.${stormBasin}.${stormYear}.season.png
    fi   
  fi
fi
###### bas do loop end ######
